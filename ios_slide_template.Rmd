...
```{r}
#PB2010 <- read.csv("PB2010.csv")
plot(PB2010$Month, PB2010$Apprehensions, col = PB2010$Sector, xlab = "Months", ylab = "Apprehensions")
...
plot(PB2017$Month, PB2017$Apprehensions, col = PB2017$Sector, xlab = "Months", ylab = "Apprehensions")

legend("topright",
          c("Apprehensions in Rio Grande Valley"),
          cex=0.8,
          bty="n",
          fill=c("pink"))
...
######The number apprehensions dropped considerably over the years.
...
From this time series, we can see that there seems to be seasonal variation in the number of apprehensions per month. It seems that this time series could probably be described using an additive model or multiplicative model. Because the seasonal fluctuations are decreasing in size over time and seems to depend on the level of the time series, we choose multiplicative model.
